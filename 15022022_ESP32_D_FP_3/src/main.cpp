...
String _device_name_master = "D_FP_3";         // Device name
String _device_name_slave = "ESP8266_SLAVE_3"; // Device name
String _status1 = "";
String _status2 = "";
int count = 10; // variable check error to restart esp

char const *_Topic_send_callmaintenance = "esp32/input/callmaintenance/D_FP_3";     // send call maintanance
char const *_Topic_receive_callmaintenance = "esp32/output/callmaintenance/D_FP_3"; // receive call maintanance

char const *_Topic_send_cancelmaintenance = "esp32/input/cancelmaintenance/D_FP_3";
char const *_Topic_receive_cancelmaintenance = "esp32/output/cancelmaintenance/D_FP_3";

char const *_Topic_send_slave = "esp8266/output/checkstatus/ESP8266_SLAVE_3";
char const *_Topic_receive_slave = "esp8266/input/checkstatus/ESP8266_SLAVE_3";
