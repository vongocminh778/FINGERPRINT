...
char const *_Topic_send_callmaintenance = "esp32/input/callmaintenance/D_FP_6";     // send call maintanance
char const *_Topic_receive_callmaintenance = "esp32/output/callmaintenance/D_FP_6"; // receive call maintanance

char const *_Topic_send_cancelmaintenance = "esp32/input/cancelmaintenance/D_FP_6";
char const *_Topic_receive_cancelmaintenance = "esp32/output/cancelmaintenance/D_FP_6";

char const *_Topic_send_slave = "esp8266/output/checkstatus/ESP8266_SLAVE_6";
char const *_Topic_receive_slave = "esp8266/input/checkstatus/ESP8266_SLAVE_6";
